...
Presentations are limited to 256 generators and 256 relations. Construction and representative lifting use the existing 5,000,000-unit Smith computation budget; exact coefficient bit lengths are unbounded. Each finite enumeration is capped at 4096 elements and either returns its complete result or fails. General homomorphisms between presentations, isomorphism witnesses, subgroup presentations, nonabelian presentations and chosen homology generators remain future work.
