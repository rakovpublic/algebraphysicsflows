...
| 2 Foundations | Native finite-set algebra; tuple/function/relation/multiset/sequence utilities | Native function/relation registrations, general infinite-set contracts |
